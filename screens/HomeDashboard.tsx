...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8FAFC', borderRadius: 16, paddingHorizontal: 16 },
  searchIcon: { color: '#94A3B8', marginRight: 12 },
  ...
  premiumBgIcon: { position: 'absolute', right: -24, bottom: -24, fontSize: 120, color: '#FFFFFF', opacity: 0.1, transform: [{ rotate: '15deg' }] },
});

const webStyles = {
  input: { flex: 1, border: 'none', background: 'none', padding: '16px 0', outline: 'none', fontSize: '14px', color: '#0F172A', fontWeight: '500' }
} as any;
