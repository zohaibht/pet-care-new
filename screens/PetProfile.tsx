...
const PetProfile: React.FC<PetProfileProps> = ({ pet, onSave, onBack }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => onSave(editedPet)} style={styles.saveBtn}>
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, height: '100%', fontSize: 16, fontWeight: '700', color: '#0F172A' },
