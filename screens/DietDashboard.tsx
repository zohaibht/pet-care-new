      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.mealSection}>
          ...
          <MealItem 
            ...
            kcal="370" 
            faded
            image="https://lh3.googleusercontent.com/aida-public/AB6AXuD4LXgrwRuEpjeXSAfd6CGpJlHq7Vn714fPhb6SrvdDZv8ppUx9TyAF_RLmerrnmqOA_hb1QJ9FXu_1_kowVKZrmjvz93vw-_LO7cWXI4l1vaghlCe-IK0kR2Kk_Ql-rPXh8Xsh8Pk-ms9DehrJ0ok9E5h5hNyDr5jUOWeIUK53O0XW1StfNmxYud3zZV6qtW3kgJeunfOVqMAFsjzRDaE0DW7jle9tzXarF3J5ssQ0jt0oAAXxJVV4f0CwO42d1dH713fVZpv08Fn4"
          />
        </View>
...
const MealItem = ({ title, time, type, weight, kcal, completed, faded, active, image }: any) => (
  <View style={[styles.mealItem, faded && { opacity: 0.5 }]}>
    ...
    <View style={styles.mealAction}>
      {completed ? (
        <Text className="material-icons-round" style={styles.doneIcon}>check_circle</Text>
      ) : (
        <TouchableOpacity style={styles.playButton}>
          <Text className="material-icons-round" style={styles.playIcon}>play_arrow</Text>
        </TouchableOpacity>
      )}
    </View>
  </View>
